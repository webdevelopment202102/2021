function togglesidebar() {
    "use strict";
    document.getElementById("sidebar").classList.toggle("uppx");
}
/*function to drobdown the menu bar*/

window.onscroll = function window() {
    "use strict";
    var oopo = document.querySelectorAll(".nav")[0];
    if (document.body.scrollTop > 500) {
        oopo.classList.add("notaion");
    } else {
        oopo.classList.remove("notaion");
    }
};
...
function progr() {
    ...
    var Name1 =   setInterval(inside1, 200);
    function inside1() {
        if (cophy1 === 40) {
            clearInterval(Name1);
        } else {
